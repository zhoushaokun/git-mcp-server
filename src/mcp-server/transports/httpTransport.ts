 ...
 */
export function getHttpSessionWorkingDirectory(sessionId: string): string | undefined {
 ...
 */
export function setHttpSessionWorkingDirectory(sessionId: string, dir: string): void {
